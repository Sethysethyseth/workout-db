...
/**
 * Shows the What's New modal once per device per release: only when logged
 * in, and only while the latest release id differs from the stored
 * last-seen id. Dismissing (button, backdrop, Escape, or the see-all link)
 * marks the release seen.
 */
