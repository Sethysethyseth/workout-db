...
/**
 * "how is this calculated?" (?) next to analytics metric labels. Same
 * fixed-position portal popover pattern as MetricInfoButton so `.table-scroll`
 * parents do not clip it, but takes { title, copy } as props.
 */
export function HowCalculatedButton({ title, copy }) {
